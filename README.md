...
This module provides payment options with Paypal for the PHP Booosta Framework. It is an early development
version that is not yet ready for production use.
